...
class EmotionAnalysisService:
    def __init__(self):
        ...
        # 설정에서 로드 (하드코딩 제거)
        self.emotion_models = EmotionConfig.get_emotion_models()
        self.parenting_emotion_map = EmotionConfig.get_parenting_emotions()
    ...
    def _get_fallback_emotion_with_keywords(self, text: str) -> Dict:
        # 설정에서 키워드 로드 (하드코딩 제거)
        emotion_keywords = EmotionConfig.get_korean_keywords()
        ...
        # 설정에서 한영 매핑 로드 (하드코딩 제거)
        korean_to_english = EmotionConfig.get_korean_to_english_mapping()
        korean_to_english["중립"] = "neutral"  # 기본값만 추가
    ...
    def _calculate_parenting_stress(
        ...
        # 설정에서 스트레스 키워드 로드 (하드코딩 제거)
        stress_keywords = EmotionConfig.get_stress_keywords()
